...
anno_rgb = np.array(anno_rgb)
anno_rgb = cv2.resize(anno_rgb, (img.shape[1],img.shape[0]), interpolation = cv2.INTER_NEAREST)

#print(anno_rgb)
#print(anno_rgb.shape)
#print(anno_rgb.dtype) #uint8
#anno_rgb = resize(anno_rgb, (250, 250)).astype(np.uint8)
#print(anno_rgb)
#print(anno_rgb.shape)
...
#anno_rgb = cv2.resize(anno_rgb,(400,500), interpolation = cv2.INTER_CUBIC)

#print(anno_rgb)
#anno_rgb = resize(anno_rgb, (img.shape[0], img.shape[1]))
##print(anno_rgb)
#print(k)
#anno_rgb = anno_rgb.astype(np.uint32)
#print(anno_rgb.shape)
...
# Added This to Avoid 0 value
anno_lbl[anno_lbl == 0] = 1

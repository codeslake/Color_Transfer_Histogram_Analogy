...
class AlignedDataset_Rand_Multi_Seg_onlymap(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'B': B, 'C' : C,
                'A_paths': A_path, 'B_paths': B_path, 'pair': pair, 'A_seg': Seg_path, 'A_map': Map}

    def __len__(self):
        return max(self.A_size, self.B_size)

    def name(self):
        return 'AlignedDataset_Rand_Multi_Seg_onlymap'
